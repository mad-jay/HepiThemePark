                ...
                <input type="hidden" name="package" value="package1">
                    ...
                    <input type="email" id="email" name="email" placeholder="john.doe@email.com" class="t1" required>
                      ...
                      <div class="elem-group inlined">
                        <label for="adult" class="l1">1-Day Hepi Theme Park Out Door Unlimited Entry - Adults</label>
                        <input type="number" id="total_adults" name="total_adults" placeholder="2" min="1" class="t1" required>
                      </div>
                      
                      <div class="elem-group inlined">
                        <label for="child" class="l1" >1-Day Hepi Theme Park Out Door Unlimited Entry - Children/Senior </label>
